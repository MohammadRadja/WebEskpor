            ...
            <div>
                <button class="btn btn-success" data-crud="add" data-method="POST" data-title="Tambah Produk"
                    ...
                    data-fields='{
                        ...
                        "id_tanaman": {"label": "Tanaman", "type": "select", "options": "tanamanListAdd"},
                        "harga": {"label": "Harga"},
        ...
        <div class="card shadow-sm">
                                        ...
                                        <button type="button" class="btn btn-sm btn-outline-success me-1" data-crud="edit"
                                            ...
                                            data-fields='{
                                                "nama": {"label": "Nama Produk", "value": "{{ $p->nama }}"},
                                                        "id_tanaman": {"label": "Tanaman", "value": "{{ $p->id_tanaman }}", "type": "select", "options": "tanamanListEdit"},
            ...
            <div class="card-footer bg-light py-2">
                <div class="d-flex justify-content-center">
                    {{ $produk->onEachSide(1)->links('vendor.pagination.bootstrap-5') }}
                </div>
            </div>
        </div>
    </div>
...
@push('scripts')
    <script>
        window.tanamanListAdd = @json($tanamanListAdd);
        window.tanamanListEdit = @json($tanamanListEdit);
    </script>
@endpush

        ...
        <div class="col-lg-10">
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body p-0">
                    ...
                    $grandTotal += $subtotal;
                    @endphp
                    <div class="cart-item border-bottom" data-item-id="{{ $item->id }}" data-price="{{ $item->produk->harga }}">
                        <div class="row align-items-center p-4 d-flex">
                            <!-- Checkbox -->
                            <div class="col-md-1 col-2">
                                <div class="form-check">
                                    <input class="form-check-input item-checkbox" type="checkbox"
                                        name="checkout_items[]" value="{{ $item->id }}"
                                        id="item-{{ $item->id }}">
                                </div>
                            </div>
                            ...
                            <!-- Actions -->
                            <form action="{{ route('cart.remove') }}" class=" w-auto" method="POST" onsubmit="return confirm('Yakin ingin menghapus barang ini dari keranjang?')">
                                @csrf
                                @method('DELETE')
                                <input type="hidden" name="product_id" value="{{ $item->produk_id }}">
                                <button type="submit" class="btn btn-outline-danger btn-sm" title="Hapus dari keranjang">
                ...
                <div class="col-lg-4 ms-auto">
                    <div class="card border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <button type="submit" class="btn btn-success w-100 py-2 fw-semibold" id="checkout-btn" disabled>
